    ...
    <section className="section-sm lg:section-lg">
      <div className="container mx-auto">
        <div className="text-center mb-16 lg:mb-32">
          <h2 className="h2 mb-3 lg:mb-[18px]" data-aos='fade-down' data-aos-delay='500'>Popular Courses</h2>
          <p className="max-w-[480px] mx-auto" data-aos='fade-down' data-aos-delay='500'>
            Practice anywhere, anytime. Explore a new way to exercise and learn
            mmore about yourself. We are providing the best.
          </p>
        </div>
        <div className="flex flex-col lg:flex-row lg:gap-x-[33px] gap-y-24mb-7 lg:mb-14">
          {courses.map((item, index) => {
            ...
            return (
              <div
                ...
                key={index} data-aos='fade-up' data-aos-delay={delay}
              >
        ...
        <div className="flex justify-center">
          <button className="btn btn-sm btn-orange" data-aos='fade-up' data-aos-delay='600'>Browse All</button>
        </div>
      </div>
    </section>
  );
